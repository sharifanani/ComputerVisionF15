...
%getSquare Function that returns the coordinates of a square after rotating
%and translating
...
SQ = scale*[v0',v1', v2', v3', v4', v5',v1']; %v1 twice to close the square
...
SQF = SQ3(1:2,:);
figure;plot(SQF(1,:),SQF(2,:));axis([-10 10 -10 10])